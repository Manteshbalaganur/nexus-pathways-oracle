...
import { FormData, FormValidation, CareerPrediction } from '@/lib/types';
...
const CareerForm: React.FC = () => {
  ...
  const handleNext = () => {
    const validationKey = `step${currentStep}` as keyof FormValidation;
      ...
      <div className="p-6 sm:p-8 glass-card rounded-xl">
        ...
        >
          <Select
            ...
            onValueChange={(value) => setFormData({ ...formData, education: value as any })}
          >
        ...
        >
          <Select
            ...
            onValueChange={(value) => setFormData({ ...formData, workEnvironment: value as any })}
          >
            <SelectTrigger className="bg-neural-dark/50 border-white/10 focus:border-neural-purple">
        ...
        >
          <RadioGroup
            ...
            onValueChange={(value) => setFormData({ ...formData, socialSkills: value as any })}
            className="space-y-3"
          >
            <div className="flex items-center space-x-2">
        ...
        >
          <RadioGroup
            ...
            onValueChange={(value) => setFormData({ ...formData, techSkills: value as any })}
            className="space-y-3"
          >
            <div className="flex items-center space-x-2">
